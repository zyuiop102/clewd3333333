...
const {randomInt, randomBytes} = require('node:crypto'), {version: Version, commit: Commit} = require('../package.json'), Encoder = (new TextDecoder, 
new TextEncoder), Main = 'clewd修改版 v' + Version + '(' + Commit + ') by tera', Replacements = {
    user: 'Human',
    assistant: 'Assistant',
    system: '',
    example_user: 'H',

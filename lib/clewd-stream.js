...
/************************ */  
    ...
    async #parseBuf(json, controller) {
        ...
        try {
            ...
            if (parsed.completion || parsed.delta.text) { //if (parsed.completion) {
                parsed.completion = genericFixes(parsed.completion || parsed.delta.text); //parsed.completion = genericFixes(parsed.completion);
